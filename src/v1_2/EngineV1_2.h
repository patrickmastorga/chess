...
private:
    ...
    public:
        ...
        Move(const EngineV1_2* board, uint8 start, uint8 target, uint8 givenFlags);
    ...
    public:
        ...
        MoveOrderer(EngineV1_2* engine, Move* moveStack, uint32 startMoves, uint32 endMoves, Move *skipThisMove=nullptr);
